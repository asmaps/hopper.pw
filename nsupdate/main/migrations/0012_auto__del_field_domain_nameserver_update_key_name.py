...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Domain.nameserver_update_key_name'
        db.delete_column(u'main_domain', 'nameserver_update_key_name')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Domain.nameserver_update_key_name'
        raise RuntimeError("Cannot reverse this migration. 'Domain.nameserver_update_key_name' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Domain.nameserver_update_key_name'
        db.add_column(u'main_domain', 'nameserver_update_key_name',
    ...
    models = {
        ...
        u'main.domain': {
            ...
            'nameserver_update_algorithm': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
