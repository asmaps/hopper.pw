...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Domain.nameserver_update_key_name'
        db.add_column(u'main_domain', 'nameserver_update_key_name',
                      self.gf('django.db.models.fields.CharField')(default='hopper.pw', max_length=256),
                      keep_default=False)
    ...
    models = {
        ...
        u'main.domain': {
            ...
            'nameserver_update_key_name': ('django.db.models.fields.CharField', [], {'max_length': '256'})
        },
        u'main.host': {
